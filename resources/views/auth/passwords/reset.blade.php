  ...
  <div class="table row-spacing1 w100">
    ...
    <input type="hidden" name="token" value="{{ $token }}">
        ...
        <div class="w100{{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            <div class="w67 textLeft">
                <input id="email" class="w67" type="email" name="email" value="{{ $email or old('email') }}" required autofocus>
            </div>
        ...
        <div class="w100{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
            ...
            <div class="w67 textLeft">
                <input id="password-confirm" class="w67" type="password" name="password_confirmation" required>
            </div>
