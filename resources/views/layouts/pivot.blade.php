...
<body>
  ...
  <div id="maincolumn">
    ...
    <div class="workspace">
      ...
      @if (Auth::guest())
        <div class="w100">
        <svg style="width: 50%; margin: auto; display: block;" viewBox="52.88655471801758 17.92185401916504 190.4696044921875 175.31439208984375" xmlns="http://www.w3.org/2000/svg">
