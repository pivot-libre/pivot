...
## Description
Pivot is a web app for conducting [Ranked Pairs](https://en.wikipedia.org/wiki/Ranked_pairs) elections. It is currently available for public testing on [pivot.vote](https://pivot.vote/). The web app uses the [Tideman library](https://github.com/pivot-libre/tideman) to compute election results.
